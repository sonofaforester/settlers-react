...
class Narrative extends React.Component<INarrativeProps, INarrativeState> {
    ...
    public render() {
        const events = this.props.eventList
            ...
            .slice(
                this.state.eventsShown === 'all' ? 0 : -this.state.eventsShown
            )
            .map((e, idx) => {
                return (
                    <li
                        key={idx}
                        className={'narrative-event ' + (e[1] ? e[1] : '')}
                    >
                        {(e[1] ? e[1] + ' ' : '') +
                            e[2] +
                            (e[0] + 1 <= this.state.verbosity
                                ? ' ' + e[3]
                                : '')}
                    </li>
                )
            ...
            <div className="narrative">
                <div className="show-options">
                    ...
                    <span
                        className={
                            'narrative-option' +
                            (this.state.eventsShown === 20 ? ' selected' : '')
                        }
                    ...
                    <span
                        className={
                            'narrative-option' +
                            (this.state.eventsShown === 40 ? ' selected' : '')
                        }
                ...
                <div className="verbosity-options">
                    ...
                    <span
                        className={
                            'narrative-option' +
                            (this.state.verbosity === 1 ? ' selected' : '')
                        }
                    ...
                    <span
                        className={
                            'narrative-option' +
                            (this.state.verbosity === 2 ? ' selected' : '')
                        }
                    ...
                    <span
                        className={
                            'narrative-option' +
                            (this.state.verbosity === 3 ? ' selected' : '')
                        }
