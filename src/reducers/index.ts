...
import {
    ACCEPT_TRADE, BANK_TRADE, BUILD_DEVELOPMENT_CARD, BUILD_ROAD, BUILD_TOWN, DECLINE_TRADE,
    DISCARD_HALF_RESOURCES, DISTRIBUTE_RESOURCES, END_PLAYER_TURN, INITIAL_MOVE_1, INITIAL_MOVE_2,
    INITIALIZE_GAME, MOVE_THIEF, OFFER_TRADE, PLAY_KNIGHT_CARD, SET_PLAYER_NAMES, UPGRADE_TOWN
} from '../actions';
import { ICatanState } from '../types';
import {
    discardHalfResources, distributeResources, endPlayerTurn, initializeState, initialMove1,
    initialMove2, moveThief, setPlayerNames
} from './basic.reducers';
import { buildDevCard, buildRoad, buildTown, upgradeTown } from './build.reducers';
import { playKnightCard } from './card.reducers';
import { acceptTrade, bankTrade, declineTrade, offerTrade } from './trade.reducers';
